  ...
  <main class="flex-1 flex flex-col min-w-0 p-6 lg:p-8 gap-6">
    ...
    <header class="flex items-center justify-between">
      <div class="flex items-center gap-4">
        ...
        <div>
          <h1 class="text-3xl lg:text-4xl font-black text-gray-800 tracking-tight" style="font-family:'Futura-Bold',Helvetica,sans-serif;">Batch Barang</h1>
          <p class="text-gray-500 text-base mt-1">Silahkan akses folder sesuai tahun yang diinginkan</p>
        </div>
      </div>
  ...
  <div id="folder-modal" class="fixed inset-0 z-50 items-center justify-center bg-black/40 backdrop-blur-sm">
    <div class="modal-animate bg-white rounded-2xl shadow-2xl w-full max-w-sm mx-4 p-7 flex flex-col gap-5">
      <div class="flex items-center justify-between">
        <h2 class="text-xl font-extrabold text-gray-900" style="font-family:'Futura-Bold',Helvetica,sans-serif;">Tambah Folder</h2>
